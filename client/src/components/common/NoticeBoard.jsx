          ...
          <div className="flex flex-col md:flex-row items-start md:items-center gap-4">
            <div className="flex items-center gap-4 w-full md:w-auto">
              ...
              <div className="flex-1 min-w-0 md:hidden">
                <div className="flex flex-wrap items-center gap-2 mb-0.5">
                  <span
                    className={`text-[8px] font-black uppercase tracking-widest px-1.5 py-0.5 rounded-full border ${getPriorityColor(currentNotice.priority)}`}
                  >
            ...
            <div className="hidden md:block flex-1 min-w-0">
              <div className="flex items-center gap-3 mb-1">
                <span
                  className={`text-[10px] font-black uppercase tracking-widest px-2 py-0.5 rounded-full border ${getPriorityColor(currentNotice.priority)}`}
                >
                  {currentNotice.priority}
                </span>
            ...
            {announcements.length > 1 && (
              <div className="flex md:flex-col items-center justify-between md:justify-center gap-3 w-full md:w-auto mt-2 md:mt-0 pt-4 md:pt-2 border-t border-white/5 md:border-t-0 md:ml-4">
                <button
                  onClick={prevNotice}
                  className="p-2.5 rounded-full bg-white/5 hover:bg-white/10 active:scale-90 transition-all text-slate-400 hover:text-white"
                >
                  <ChevronLeft size={18} />
                </button>
                <div className="text-[10px] font-mono text-center text-slate-400 bg-white/5 px-3 py-1.5 rounded-full border border-white/5">
                  {currentIndex + 1} <span className="opacity-30">/</span>{" "}
