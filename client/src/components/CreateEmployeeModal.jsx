                ...
                <form onSubmit={onSubmit} className="p-6 space-y-4">
                    ...
                    {(isAdmin || isManager) && (
                        <div className="space-y-4">
                            <div className="bg-emerald-50/30 p-4 rounded-xl border border-emerald-100 flex items-center justify-between">
                                <div className="flex items-center gap-2">
                                    <span className="text-lg">🏡</span>
                                    <div>
                            ...
                            <div className="bg-indigo-50/30 p-4 rounded-xl border border-indigo-100 flex items-center justify-between">
                                <div className="flex items-center gap-2">
                                    <span className="text-lg">📞</span>
                                    <div>
                                        <p className="text-xs font-bold text-slate-800">Allow Call Analytics</p>
                                        <p className="text-[9px] text-slate-500">Enable Call Analytics reports</p>
                                    </div>
                                </div>
                                <label className="relative inline-flex items-center cursor-pointer">
                                    <input
                                        type="checkbox"
                                        className="sr-only peer"
                                        checked={formData.callAnalyticsViewEnabled}
                                        onChange={(e) => setFormData({ ...formData, callAnalyticsViewEnabled: e.target.checked })}
                                    />
