            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <motion.div whileHover={{ y: -5 }} className="bg-white p-6 rounded-3xl shadow-sm border border-slate-100 group">
                    ...
                    <p className="text-2xl font-black text-slate-800">
                        ₹{spentHistory
                            .filter(v => ['PENDING', 'APPROVED', 'WAITING'].includes(v.status))
                ...
                >
                    ...
                    <p className="text-2xl font-black text-slate-800">{spentHistory.filter(v => ['PENDING', 'APPROVED', 'WAITING'].includes(v.status)).length}</p>
                </motion.div>
            </div>
